...
4. **READ-ONLY State Files**
   ...
   - Single-writer pattern: Only gsd-executor manages state files
   - Return structured output instead - gsd-executor will update state
   - If you find plan issues: Document in deviations field, don't modify PLAN.md
