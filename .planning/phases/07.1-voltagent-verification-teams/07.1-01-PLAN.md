...
files_modified:
  ...
  - /Users/matte/Documents/workspace/get-shit-done/get-shit-done/templates/plan.md
autonomous: true
...
must_haves:
  truths:
    ...
    - "Tasks can specify verification_tier in PLAN.md frontmatter"
  artifacts:
    ...
    - path: "/Users/matte/Documents/workspace/get-shit-done/get-shit-done/templates/plan.md"
      provides: "Task frontmatter with verification_tier field"
      contains: "verification_tier:"
  key_links:
    ...
    - from: "PLAN.md task"
      to: "verification tier"
      via: "frontmatter parsing"
      pattern: "verification_tier:"
---
...
<task type="auto">
  ...
  <verify>node /Users/matte/Documents/workspace/get-shit-done/get-shit-done/bin/gsd-tools.cjs determine-verification-tier "Add user authentication" "src/auth/login.ts" | grep '"tier": 3'</verify>
...
<task type="auto">
  ...
  <verify>grep -A 20 "spawn code-reviewer" /Users/matte/Documents/workspace/get-shit-done/get-shit-done/workflows/execute-phase.md</verify>
...
<task type="auto">
  ...
  <verify>grep "verification-brief.md" /Users/matte/Documents/workspace/get-shit-done/get-shit-done/workflows/execute-phase.md</verify>
  <done>Verification specialists receive focused context and results are processed</done>
</task>

<task type="auto">
  <name>Task 4: Document verification_tier field in PLAN.md template</name>
  <files>/Users/matte/Documents/workspace/get-shit-done/get-shit-done/templates/plan.md</files>
  <action>
    Update the PLAN.md template to document the verification_tier field for tasks:

    1. Add to the task frontmatter section:
       ```markdown
       ## Task Frontmatter (Optional)

       Tasks can include frontmatter to control verification behavior:

       ```yaml
       <task type="auto" verification_tier="3">
         <name>Task with forced Tier 3 verification</name>
         ...
       </task>
       ```

       **verification_tier:** Override automatic tier detection
       - `0` - Skip verification for this task
    ...
    2. Update gsd-tools determine-verification-tier to check for this override:
       - First check if task has verification_tier attribute
       - If present, use that tier (unless 0, which means skip)
       - Otherwise, use keyword-based detection

    3. Add example to the template showing a security task with explicit tier:
       ```xml
       <task type="auto" verification_tier="3">
  ...
  <verify>grep -A 5 "verification_tier" /Users/matte/Documents/workspace/get-shit-done/get-shit-done/templates/plan.md</verify>
  <done>PLAN.md template documents verification_tier field for task-level control</done>
</task>
...
- Tasks can override verification tier via frontmatter
</verification>
...
- PLAN.md template documents verification_tier field
</success_criteria>
